(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-cascading-dropdown-lib', ['exports', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (global = global || self, factory(global['ng-cascading-dropdown-lib'] = {}, global.ng.core, global.ng.forms, global.ng.common));
    ...
    var NgCascadingDropdownLibService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgCascadingDropdownLibService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgCascadingDropdownLibService_Factory() { return new NgCascadingDropdownLibService(); }, token: NgCascadingDropdownLibService, providedIn: "root" });
    ...
    var NgCascadingDropdownLibComponent = /** @class */ (function () {
        ...
        function NgCascadingDropdownLibComponent() {
            ...
            this.notifyFinalDropDownValue = new core.EventEmitter();
            // Notify all the Selected Values per dropdown
            this.notifyDropDownValue = new core.EventEmitter();
            // Notify if dropdown value is changed
            this.notifyChangeEvent = new core.EventEmitter();
        }
        /**
        ...
        NgCascadingDropdownLibComponent.propDecorators = {
            inputCascadingData: [{ type: core.Input }],
            defaultSelectionData: [{ type: core.Input }],
            disableDropdown: [{ type: core.Input }],
            showDefaultSelection: [{ type: core.Input }],
            showHorizontal: [{ type: core.Input }],
            notifyFinalDropDownValue: [{ type: core.Output }],
            notifyDropDownValue: [{ type: core.Output }],
            notifyChangeEvent: [{ type: core.Output }]
        };
    ...
    exports.NgCascadingDropdownLibComponent = NgCascadingDropdownLibComponent;
    exports.NgCascadingDropdownLibModule = NgCascadingDropdownLibModule;
    exports.NgCascadingDropdownLibService = NgCascadingDropdownLibService;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ng-cascading-dropdown-lib.umd.js.map
